...
namespace System.Security
{
    public partial class SecurityHelper
    {
        ...
        public static string AESEncrypt(string encryptString, string encryptKey = "Windows@2012")
        {
        ...
        public static string AESDecrypt(string decryptString, string decryptKey = "Windows@2012")
        {
            try
            {
